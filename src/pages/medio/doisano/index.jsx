    ...
    return (
        <div className="container">
            ...
            <div className="button-container-serie">
                <button id="Bumano" className="button-serie" onClick={handleClick}>2ºA</button>
                <button id="Bumano" className="button-serie" onClick={handleClick}>2ºB</button>
                <button id="Bumano" className="button-serie" onClick={handleClick}>2ºC</button>
                <button id="Bumano" className="button-serie" onClick={handleClick}>2ºD</button>
                <button id="Bumano" className="button-serie" onClick={handleClick}>2ºE</button>
                <button id="Bumano" className="button-serie" onClick={handleClick}>2ºF</button>
            </div>
            {modal && 
                <div className="modal">
