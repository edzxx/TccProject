    ...
    return (
        <div className="container">
            ...
            <div className="button-container-serie">
                <button id="Bumano" className="button-serie" onClick={handleClick}>3ºA</button>
                <button id="Bumano" className="button-serie" onClick={handleClick}>3ºB</button>
                <button id="Bumano" className="button-serie" onClick={handleClick}>3ºC</button>
                <button id="Bumano" className="button-serie" onClick={handleClick}>3ºD</button>
                <button id="Bumano" className="button-serie" onClick={handleClick}>3ºE</button>
                <button id="Bumano" className="button-serie" onClick={handleClick}>3ºF</button>
            </div>
            {modal && 
                <div className="modal">
