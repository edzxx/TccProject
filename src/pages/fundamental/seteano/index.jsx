        ...
        <>
            <div className="container">
                ...
                <div className="button-container-serie">
                    <button id="Bumano" className="button-serie" onClick={handleClick}>7ºA</button>
                    <button id="Bumano" className="button-serie" onClick={handleClick}>7ºB</button>
                    <button id="Bumano" className="button-serie" onClick={handleClick}>7ºC</button>
                    <button id="Bumano" className="button-serie" onClick={handleClick}>7ºD</button>
                    <button id="Bumano" className="button-serie" onClick={handleClick}>7ºE</button>
                    <button id="Bumano" className="button-serie" onClick={handleClick}>7ºF</button>
                </div>
            </div>
            {modal && (
                <Modal
...
const Modal = ({turma, quantidade, setQuantidade, handleClose, handleAbrirConfirmacao}) => {
    return (
        <div className="modal">
